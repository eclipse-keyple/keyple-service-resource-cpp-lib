...
public:
    ...
    public:
        ...
        /**
         * Configures the card resource service to search for available cards in
         * pool plugins before regular plugins.
         *
         * <p>Default value: pool last
         *
         * @return The current builder instance.
         * @throw IllegalStateException If the setting has already been
         *        configured.
         * @since 2.0.0
         */
         ...
         *
         * <p><u>Note:</u> The order of the plugins is important because it
         * will be kept during the allocation process unless redefined by card
         * profiles.
         *
         * @param poolPlugin The pool plugin to add.
         * @return The current builder instance.
         * @throw IllegalArgumentException If the provided pool plugin is null.
         * @throw IllegalStateException If the pool plugin has already been
         *        configured.
         * @since 2.0.0
         */
        Builder& 
        addPoolPlugin(std::shared_ptr<PoolPlugin> poolPlugin);

        /**
         * Creates a new instance of {@link PoolPluginsConfigurator} using the
