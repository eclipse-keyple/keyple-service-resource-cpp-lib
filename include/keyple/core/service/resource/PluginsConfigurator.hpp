...
public:
    ...
    enum class AllocationStrategy {
        /**
         * Configures the card resource service to provide the first available
         * card when a card allocation is made.
         *
         * @since 2.0.0
         */
        FIRST,
        ...
        /**
         * Configures the card resource service to provide available cards on a
         * cyclical basis to avoid always providing the same card.
         *
         * @since 2.0.0
         */
        CYCLIC,
        ...
        /**
         * Configures the card resource service to provide available cards
         * randomly to avoid always providing the same card.
         *
         * @since 2.0.0
         */
        RANDOM
    ...
    /**
     * This POJO contains a plugin and the parameters that have been associated
     * with it.
     *
     * @since 2.0.0
     */
    ...
    public:
         ...
         * @param pluginObservationExceptionHandlerSpi The plugin exception
         *        handler to use.
         * @param readerObservationExceptionHandlerSpi The reader exception
         *        handler to use.
         * @since 2.0.0
         */
        ConfiguredPlugin(
        ...
        /**
         * @return A not null {@link ReaderConfiguratorSpi} reference if reader
        ...
        /**
         * @return A not null {@link PluginObservationExceptionHandlerSpi}
         *         reference if reader monitoring is requested.
         * @since 2.0.0
         */
        std::shared_ptr<PluginObservationExceptionHandlerSpi>
        ...
        /**
         * @return A not null CardReaderObservationExceptionHandlerSpi reference
         *         if card monitoring is requested.
         * @since 2.0.0
         */
        std::shared_ptr<CardReaderObservationExceptionHandlerSpi>
     ...
     * @since 2.0.0
     */
    class KEYPLESERVICERESOURCE_API Builder final {
    public:
        /**
         *
         */
        ...
        /**
         * Specifies the allocation strategy to perform when a card resource is
         * requested.
         *
         ...
         * @throw IllegalStateException If the strategy has already been
         * configured.
         * @since 2.0.0
         */
        Builder&
        withAllocationStrategy(const AllocationStrategy allocationStrategy);

        /**
         * Specifies the timeout to use after that an allocated card resource
         * can be automatically re-allocated by card resource service to a new
         * thread if requested.
         *
         ...
         * (in milliseconds).
         * @return The current builder instance.
         * @throw IllegalArgumentException If the provided value is less or
         * equal to 0.
         * @throw IllegalStateException If the timeout has already been
         * configured.
         * @since 2.0.0
         */
        Builder& 
        withUsageTimeout(const int usageTimeoutMillis);

        /**
         * Adds a {@link Plugin} or {@link ObservablePlugin} to the default list
         * of all card profiles.
         *
         * <p><u>Note:</u> The order of the plugins is important because it will
         * be kept during the allocation process unless redefined by card
         * profiles.
         *
         * @param plugin The plugin to add.
         * @param readerConfiguratorSpi The reader configurator to use when a
         *        reader is connected and accepted by at leas one card resource
         *        profile.
         * @return The current builder instance.
         * @throw IllegalArgumentException If the provided plugin or reader
         *        configurator is null or if the plugin is not an instance of
         *        Plugin or ObservablePlugin.
         * @throw IllegalStateException If the plugin has already been
         *        configured.
         * @since 2.0.0
         */
        Builder& 
        ...
        /**
         * Adds a {@link Plugin} or {@link ObservablePlugin} to the default list
         * of all card profiles with background auto monitoring of reader
         * connections/disconnections and/or card insertions/removals.
         *
         * <p><u>Note:</u> The order of the plugins is important because it will
         * be kept during the allocation process unless redefined by card
         * profiles.
         *
         * <p>The plugin or readers must be observable for the monitoring
         * operations to have an effect.
         *
         * @param plugin The plugin to add.
         * @param readerConfiguratorSpi The reader configurator to use when a
         *        reader is connected and accepted by at leas one card resource
         *        profile.
         * @param pluginObservationExceptionHandlerSpi If not null, then
         *        activates the monitoring of the plugin and specifies the
         *        exception handler to use in case of error occurs during th
         *        asynchronous observation process.
         * @param readerObservationExceptionHandlerSpi If not null, then
         *        activates the monitoring of the readers and specifies the
         *        exception handler to use in case of error occurs during the
         *        asynchronous observation process.
         * @return The current builder instance.
         * @throw IllegalArgumentException If the provided plugin or reader
         *        configurator is null or if the plugin is not an instance of
        ...
        /**
         * Creates a new instance of {@link PluginsConfigurator} using the
    ...
    /**
     * (package-private)<br>
     * Gets the list of all configured "regular" plugins with their associated
     * configuration.
     *
    ...
    /**
     * C++: should be private but prevent the use of make_shared from Builder
     * class.
     */
